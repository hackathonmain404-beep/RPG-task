...
The competition permits React, Node.js/Express and PostgreSQL and explicitly allows multiple backend/database choices.
...
The problem explicitly disqualifies fake primary persistence through localStorage. Primary user data must live in the backend database.
