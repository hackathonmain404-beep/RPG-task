...
export const LoginPage: React.FC = () => {
  ...
  const { login, loginWithGithub, serverReachable } = useAuth();
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} noValidate>
          {/* GitHub 1-Click Auth Button */}
          <button
            type="button"
            disabled={isSubmitting}
            onClick={async () => {
              const ghUsername = prompt('Enter your GitHub username to embark:');
              ...
              try {
                if (loginWithGithub) {
                  ...
                  await login({ email: ghUsername.trim(), password: 'github-oauth-pass' });
                }
                navigate(redirectUrl, { replace: true });
              } catch (err: any) {
          ...
          >
            ...
            <span>or with master key</span>
            <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255,255,255,0.1)' }} />
          </div>

          <div style={{ marginBottom: '1.25rem' }}>
            <label htmlFor="login-email" className="rpg-label">
              Adventurer Email or GitHub Username
            </label>
            <div style={{ position: 'relative' }}>
              <input
                ...
                placeholder="adventurer@example.com or octocat"
