...
export const SettingsPage: React.FC = () => {
  ...
  const { user, character, logout, updateProfile, refreshCharacter, refreshSession } = useAuth();
  ...
  // Automatically ensure freshest character progression & session on mount
  useEffect(() => {
    void refreshCharacter();
    void refreshSession();
  }, [refreshCharacter, refreshSession]);
